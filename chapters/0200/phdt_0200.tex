...
\begin{equation}
    ...
    2 \frac{Q_{z,b} - Q_{z,f}}{s_{z,b} + s_{z,f}} = A_0
\end{equation}
...
\begin{split}    
    ...
    2 \frac{
            \left(
                ...
                \displaystyle \frac{T_5 - T_0}{s_{y,b}} \right ) -
            \left(
                \displaystyle \frac{k_6 + k_0}{2}
                \displaystyle \frac{T_0 - T_6}{s_{y,f}}
            \right )
        }{s_{y,b} + s_{y,f}} &+ \\[1ex]
    2 \frac{
            \left(
...
\begin{split}  
    ...
    \frac{
        ...
        \displaystyle\frac{(k_4 + k_0) (T_0 - T_4)}{s_{x,f}}
        }
    {s_{x,b} + s_{x,f}} = \\[2ex]
    = &
    \frac{(k_0 + k_3) (T_3 - T_0)}{s_{x,b} (s_{x,b} + s_{x,f})} -
    \frac{(k_4 + k_0) (T_0 - T_4)}{s_{x,f} (s_{x,b} + s_{x,f})} = \\[2ex]
    = &
...
\begin{align}
    ...
    % 0 here is incomplete, missing part from y and z terms
