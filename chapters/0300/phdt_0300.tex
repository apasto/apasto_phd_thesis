...
% sediments
\paragraph*{Sediments correction.}
...
The sediment-corrected NETC retains the bi-modal distribution which already characterises the NETC, likely arising from the ocean-continent dichotomy of the terrain correction (Fig.~\ref{fig:E2014fwd_out_TC_g_rad}).
...
A bi-modal distribution, superposition of an ocean and a continent member, can be identified - the continent distribution showing a much wider dispersion.
The gravity effect ($g_z$) in all grid-nodes over continents is consistently negative.
Over oceans, part of the signal is positive.
Fig.~\ref{fig:} shows an histogram of the crustal $g_z$ effect with above-sea-level and below-sea-level nodes separated.
Albeit a degree of mixing between oceanic and continental masses is unavoidable, the two aforementioned terms are evident (average and standard deviation, oceans: $\overline{g_z}$ \SI{-92.2}{mGal}, $\sigma(g_z)$ \SI{87.5}{mGal}; continents: $\overline{g_z}$ \SI{-406.9}{mGal}, $\sigma(g_z)$ \SI{179.2}{mGal}).

% perché ho negativo in oceani?
% perché ho densità CRUST3 minori di media a quota CRUST3
% (forse urge mappa densità?)
...
% consistently lower - consistent mass deficit - excess mass
% quindi? esempio, effetto 3300 in reference?


%assuming a perfect model of known-masses
% interpretazione
