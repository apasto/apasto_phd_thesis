...
\subsection{Testing the method against spatial--domain forward modelling}
...
\begin{figure}
    ...
    \end{adjustbox}
    \caption[Radial component of the terrain correction, corrections included.]{Radial component of the terrain correction, corrections included. It is expressed as positive upwards (i.e. the attraction of solid topography is negative). The histogram over the colour scale is equal-area normalised.}
...
%           \textbf{Orange}:~constant density layers obtained from the \textit{ak135} model.}%
%       \label{fig:SigIs:Ref_ak135}
%     }
%     \floatbox{figure}[0.45\textwidth]{%
%       \begin{tabular}{rl}
%         \toprule
...
%       \end{tabular}
%     }{%
%       \caption[Layer-discretised reference densities.]{Layer-discretised reference densities, modified from \textit{ak135}.}%
%       \label{fig:SigIs:Ref_ak135_table}
%     }
%     \end{floatrow}
%     \end{center}
%     \end{minipage}
