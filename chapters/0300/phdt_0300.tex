...
The in-slice global average of {LITHO1.0} densities computed there is equal to \SI{2685}{\kilo \gram \per \cubic \metre}, only \SI{15}{\kilo \gram \per \cubic \metre} denser than the adopted \SI{2670}{\kilo \gram \per \cubic \metre} constant density topography.
