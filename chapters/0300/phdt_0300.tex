...
Therefore, the higher mountain ranges still account for all the localised values on the high end of the range (more than \SI{600}{mGal}) -- their aforementioned `crustal over-correction' is only partially compensated by the opposed-sign LID correciton.
...
% richiamo al fatto che 3300 è riferimento

% commento istogrammi
% che differenza tra shallow e deep?
