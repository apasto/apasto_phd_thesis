        ...
        \fbox{
            \begin{tabular}{c}
                ...
                \begin{overpic}[width=\textwidth]{maps/sig_isol/BG_SedC.pdf}
                    \put (0,65) {\textsf{\textbf{BG, SEDS corr.}}}
                \end{overpic}
            \end{tabular}
        }
    \end{adjustbox}
        ...
        \fbox{
            \begin{tabular}{c}
                ...
                \begin{overpic}[width=\textwidth]{maps/sig_isol/BG_CrustC.pdf}
                    \put (0,65) {\textsf{\textbf{BG, CRUST corr.}}}
                \end{overpic}
            \end{tabular}
        }
    \end{adjustbox}
...
\begin{figure}
    ...
    \end{adjustbox}
    \caption[TO DO.]{This is the same quantity plotted in the top map of Fig.~\ref{fig:SigIs:Res:CRUST}, using a different colour scale, without clipping the most negative values.}
        ...
        \fbox{
            \begin{tabular}{c}
                ...
                \begin{overpic}[width=\textwidth]{maps/sig_isol/BG_ShallowC.pdf}
                    \put (0,65) {\textsf{\textbf{BG, 0--80~km corr.}}}
                \end{overpic}
            \end{tabular}
        }
    \end{adjustbox}
        ...
        \fbox{
            \begin{tabular}{c}
                ...
                \begin{overpic}[width=\textwidth]{maps/sig_isol/BG_DeepC.pdf}
                    \put (0,65) {\textsf{\textbf{BG, 0--310~km corr.}}}
                \end{overpic}
            \end{tabular}
        }
    \end{adjustbox}
...
\subsubsection{Propagated uncertainty}
