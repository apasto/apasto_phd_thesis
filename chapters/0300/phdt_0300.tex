...
In the context of these experiments, {LITHO1.0} provides a global, readily accessible model of density in the lithosphere, at a nominal resolution which is comparable with the current resolving power of satellite--only global gravity models (more precisely, of geophysical inversion based on satellite--only GGMs).
