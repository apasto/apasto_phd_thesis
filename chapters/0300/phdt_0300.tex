...
\begin{figure} % 4 blocks, deg var spectra comparison: 1 relief vs layers
    ...
    \caption[``Single-relief'' against layer-wise comparison: degree variance and difference spectra.]{
        ...
        Note that no difference can be appreciated between the two plotted curves.
        The \textbf{lower panel} show the cumulative degree standard deviation spectra of the differences in radial component of gravity ($g_r$), computed as layer-wise minus single-relief.}
