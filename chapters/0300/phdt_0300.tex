...
% expressed as degree variances (section~\ref{ss:SigIs:Fwd:Spectrum}, Eq.~\ref{eq:DegVar}) in Fig.~\ref{fig:SigIs:Spec:DegVarAll}

% consistent with
% monotonically decreasing

% seconda figura: shell-wise

% deg var semplici (non le xcorr, sono dopo)
% CONSIDERAZIONE IMPORTANTE:
% segnale a bassi gradi implica che
% 1) cut off non garantisce di isolare segnale profondo mantello
% 2) con compensazione isostatica però mi aspetterei la uno sia vera...
% 3) punto a segnale mantello con queste correzioni?
%    ...attenzione: introduco errore anche nei bassi gradi
