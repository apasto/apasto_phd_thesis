...
This procedure also provided, collaterally, novel statistics on the average depth and densities of {LITHO1.0} layers, taken individually and grouped (tables~\ref{tab:LithoLayers} and~\ref{tab:LithoLayersGroups}).
...
%The `shell-wise' corrections

% histogram, statistics
% una frase su qualità e significato dei risultati
% accenno a over-correction
