...
A synthetic mass distribution was defined, made up of four 2$times$2~degree ``blocks'', \SI{1}{\kilo \metre} thick.
...
The resulting relief map is plotted in Fig.~\ref{fig:SpatSpecComp:4B_DepthMap}, zoomed in on the area covered by the blocks.
The rest of the grid, of global extent, contains no other masses.
...
It is expressed cumulatively, reaching a maximum of \SI{0.512}{mGal} at $l_{max}$.
