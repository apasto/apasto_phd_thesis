...
Loss of terrain-gravity correlation occurs also at low degrees (less than \num{10}), where they are usually attribued to deep density inhomogeneities \parencite{Kaban2004} not associated with an expression in topography.

Interpreting correlations between the input GGM and the forward-modelled masses from LTIHO1.0 (middle and bottom panel of Fig.~\ref{fig:SigIs:Res:XCorr}) is less straighforward.
% RIVEDERE QUESTA PARTE ISOSTATICA
%Under the hypothesis that the non-reduced GGM
%lithospheric masses should be 
%Cross correlation coefficients enable to assess
...
% QUI: fare crust vs lid CC
% idealmente, ridotte dovrebbero non correllare
% cito lavoro su delta rho decorrelato (tenzer?)
