...
A radially-stratified model of the interior (actually made of concentric ellipsoidal shells, or \textit{homeoids}), such as the PREM \parencite[Preliminary Reference Earth Model,][]{Dziewonski1981}, should satisfy this condition \parencite{Tscherning1981}.
...
\begin{figure}
    \begin{adjustbox}{center}
        \fbox{
            \Large{Placeholder, tectonothermal ages global map.}
        }
    \end{adjustbox}
    \caption[Tectonothermal age partition of the lithospheric mantle.]{Two-member tectonothermal age partition of the lithospheric mantle, derived from the crustal types by \textcite{Laske2012Crust10}.}
...
\begin{figure}
    \begin{adjustbox}{center}
        \fbox{
            \Large{Placeholder, velocity-density curves.}
        }
    \end{adjustbox}
    \caption[Pressure, shear wave velocity and density conversion curves.]{
        Temporary caption.
    }
...
Conversion results, condensed after slicing using a thickness-weighted average, are shown in Fig.~\ref{fig:SigIs:LID_density_map}.

\begin{figure}
    \begin{adjustbox}{center}
        \fbox{
            \Large{Placeholder, LID density map.}
        }
    \end{adjustbox}
    \caption[Density in the lithospheric mantle (LID) after conversion.]{Global map of the lithospheric mantle (LID) density, obtained by velocity-density-conversion.}
    \label{fig:SigIs:LID_density_map}
\end{figure}
...
These ranges define a set of ellipsoidal shells of homogeneous density.
...
\begin{figure}
    \begin{adjustbox}{center}
        \fbox{
            \Large{Placeholder,  \textit{layer-slices} example.}
        }
    \end{adjustbox}
    \caption[Temp caption.]{Temp caption.}
...
the case of an homogeneous homeoid \parencite{Moritz1990}
more complex
external potential
stops at degree % cito... Hirt and Rexer? fino a che grado
