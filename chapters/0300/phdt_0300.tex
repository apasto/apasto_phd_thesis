        ...
        \fbox{
            \begin{tabular}{c}
                \includegraphics[
                    clip, trim=0.2cm 0.35cm 0.1cm 7.5cm,
                    width=1.2\textwidth
                ]{maps/spectra/XCorr_ISO.pdf}\\
            \end{tabular}
        }
    \end{adjustbox}
    \caption[Degree correlation coefficients (CC) between the uncompensated NETC and the crust- and lithosphere-corrected NETC.]{Degree correlation coefficients (\textbf{CC}, $S_{fg}$ of Eq.~\ref{eq:DegVarCross}) between the terrain-correction only NETC disturbance and the NETC corrected for the crust and lithosphere.}
