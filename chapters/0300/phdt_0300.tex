...
The `normal density reference' tailored to {LITHO1.0} densities and the `asthenosphere fill-in' is presented in Fig.~\ref{fig:SigIs:Ref_ak135} (black line) and in Tab.~\ref{tab:Ref_ak135}.
