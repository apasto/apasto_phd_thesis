...
\begin{figure}
    ...
    \caption[Map of the global gravity model $\delta g$ and NETC $\delta g$.]{
        ...
        \textbf{Bottom: NETC.} No Ellipsoidal Topography corrected gravity disturbance, resulting from applying the forward-modelled Earth2014 \parencite{Hirt2015} data to the GGM.
    }
...
\subsection{Discussion} % VALUTARE SE NECESSARIA DISCUSSION
