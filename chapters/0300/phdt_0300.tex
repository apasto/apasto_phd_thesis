...
It ought to be noted that the method proposed and tested here can be easily scaled to more complex error models.
...
The number of necessary random draws is a trade-off between insufficient sampling of the error density function (due to low values) and computation time.
It was chosen heuristically, choosing \num{5000}~draws as
