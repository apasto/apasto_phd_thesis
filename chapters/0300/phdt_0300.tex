...
Therefore, I have grouped the crustal types from {CRUST1.0} \parencite{Laske2012Crust10} in a simplified three-member model of LID composition.
The result of this partition is shown in Fig.~\ref{fig:SigIs:LithoAges}.
These members, accompanied by their code in \textcite{Griffin2009}, are: \textit{archon} (Arc\_1), \textit{proton} (Pr\_4), and \textit{tecton} (Tc\_1)
...
\begin{figure}
    ...
    \end{adjustbox}
    \caption[Tectonothermal age partition of the lithospheric mantle.]{Three-member tectonothermal age partition of the lithospheric mantle, derived from the crustal types by \textcite{Laske2012Crust10}.}
...
% It must be noted that this conversion
% usable
% observation-based model

% provide mutual constraints
% regional studies
...
% provide mutual constraints % kaban, tesauro, temperature da tomografia

% given the

\subsection{Reference densities: layered normal Earth}
\label{ss:SigIs:InModels:REF}
% AK135 \parencite{Kennett1995_ak135}
