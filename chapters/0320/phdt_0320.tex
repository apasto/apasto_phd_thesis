...
\begin{equation}
    ...
    S_{fg}(l) = \sum_{m=-l}^{l} f_{lm} \enskip g_{lm}
\end{equation}
Note that the cross-power spectrum obtained with this equation \parencite[Eq.~12 in][]{Wieczorek2007} differs from other common formulations \parencites[e.g.][]{Phillips1980}{Rapp1982}{Rexer2016} by a factor \sloppy{${[S_{ff}(l) \cdot S_{gg}(l)]^{(-1/2)}}$}, which was not applied here.
