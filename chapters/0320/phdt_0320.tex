...
They provide a global model of the lithosphere, from the topography to the base of lithospheric mantle (lithosphere--asthenosphere boundary, LAB), parametrized vertically in a serie of `geophysical layers'.
Horizontally (i.e. referring to the Earth surface) data is discretised on a \SI{1}{\degree} icosahedron--based tesselation.
...
The water and ice layers were discarded, since {Earth2014} \parencite{Hirt2015} relies 
the topographic surface
the top of the model has been re-referenced to the bottom of the {Earth2014} extra


Extraction to a regular grid
was performed using
% CITARE da poster
