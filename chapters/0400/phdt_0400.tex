...
The new inverted Moho, in Fig.~\ref{fig:RhoTP_MohoDepth}, shows a variation (after minus before) ranging from $-2.3$~\si{\kilo \metre} to $+3.4$~\si{\kilo \metre}, with an average of $-0.13$~\si{\kilo \metre} and a standard deviation of $0.75$~\si{\kilo \metre}. The range and variance of these discrepancies are less than the typical uncertainties of crustal thickness estimation ($\pm 5$ to $\pm 15$ percent, i.e. $\pm 2$ to $\pm 6$~\si{\kilo \metre} for a $40$~\si{\kilo \metre} thick crust, see \cite{Grad2009} and references therein).
