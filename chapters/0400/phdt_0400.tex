...
\paragraph*{Foreword.}
The technique applied in this chapter stems from the thermal model described in the supplementary chapter~\ref{c:ThermModel} and shares part of the strategies devised for the gravity data reduction strategy presented in chapter~\ref{c:SigIs}.
...
This application, edited in a suitable manuscript form, was submitted to Geophysical Journal International on 26~February~2019.
